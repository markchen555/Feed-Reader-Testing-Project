...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        // Make sure Asynchronous done before test. 
         ...
         */
        it('the loadFeed funciton is called and completes it\'s work', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        var initFeed, newFeed;
        // Make sure Asynchronous done before test.
        beforeEach(function(done) {
            loadFeed(0, function() {
                initFeed = $('.feed').find("h2").text();
                loadFeed(1, function() {
                    done();
                })
            });
         ...
         */
        it('changes when a new feed is loaded by the loadFeed function', function(done) {
